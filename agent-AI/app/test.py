...
for character in characters:
    f = open(("data/heard_conversation_"+character+'.txt'), 'w')
    f.write("*CONVERSATION ENTENDUE")
    f.close()
    f = open(("data/conversations_"+character+'.txt'), 'w')
    f.write("*CONVERSATION")
    f.close()
    f = open(("data/npc_"+character+'.txt'), 'w')
    f.write("*INFORMATION PNJ")
    f.close()
    f = open(("data/relations_"+character+'.txt'), 'w')
    f.write("*RELATIONS")
    f.close()
